...
别人扫码进入链接显示如下图：
![打开首屏](https://github.com/MisterChangRay/car-notify/blob/main/example1.jpg){: width="50%"}
![点击拨号](https://github.com/MisterChangRay/car-notify/blob/main/example2.jpg){: width="50%"}
